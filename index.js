// Targeting the HTML elements using their class names.
const input_element = document.querySelector(".input");
const output_operation_element = document.querySelector(".operation .value");
const output_result_element = document.querySelector(".result .value");

// Object Method to create all of Our Buttons
...
// Arrays to stores Operations and Results for the Users
let data = {
    operation : [],
    result : [],
}

// Creating the Button rows and buttons using the DOM methods
...
// Event Listener to check the Button Type a User clicks on
...
// Function to update the output operations for the Users
function updateOutputOperation(operation){
    output_operation_element.innerHTML = operation;
}

// Function to Update the Output result for the User
...
// Function to Formate the Output for the User
